...
<section class="hero">
  <div class="hero-slides">
    <div class="hero-slide active" style="background-image: url('../assets/imgs/bahia-vitoria.jpg')"></div>
    <div class="hero-slide" style="background-image: url('../assets/imgs/baiavitoria2.jpg')"></div>
    <div class="hero-slide" style="background-image: url('../assets/imgs/convento1.jpg')"></div>
  </div>
