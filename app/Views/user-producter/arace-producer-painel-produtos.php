...
<head>
  ...
  <title>Aracê — Meus Produtos</title>
  ...
  <link href="../assets/style/painel-produtos.css" rel="stylesheet" />
</head>
<body>
  ...
  <aside>
    ...
    <a class="nav-item active" href="./arace-producer-painel-produtos.php"><i data-lucide="shopping-bag"></i> Meus produtos</a>
  ...
  <main>
    <!-- conteúdo de Meus Produtos aqui -->
  </main>
