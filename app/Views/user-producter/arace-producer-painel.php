...
<head>
  ...
  <link href="../assets/style/painel.css" rel="stylesheet" />
</head>
<body>
  ...
  <aside>
    ...
    <a class="nav-item active" href="./arace-producer-painel.php"><i data-lucide="layout-dashboard"></i> Painel</a>
