  ...
  <div class="login-card cadastro-card item-animado">
    ...
    <form id="formCadastroDono" action="/produtor/perfil-loja" method="get" novalidate>
      ...
      <div class="input-group-custom item-animado atraso-2">
        ...
        <input type="text" id="nome-dono" name="nome" placeholder="Nome completo" required />
      </div>
      ...
      <div class="input-group-custom item-animado atraso-3">
        ...
        <input type="email" id="email" name="email" placeholder="E-mail de acesso" required />
      </div>

      <div class="input-group-custom item-animado atraso-3">
        <i data-lucide="phone"></i>
        <input type="tel" id="telefone" name="telefone" placeholder="Telefone / Celular" required />
      </div>
